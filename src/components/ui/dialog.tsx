...
const registerDialogComponent = (registry: DialogComponentRegistry, component: unknown) => {
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        {...props}
      >
        {ensureTitle && <DialogPrimitive.Title className="sr-only">Dialog</DialogPrimitive.Title>}
        {ensureDescription && (
