...
export const FiltersDrawer = ({
  ...
  const { draft, setDraft, applyFilters, resetFilters, activeCounts, modifiedSinceApply } =
  ...
  const intensityAria = useCallback(
    (type: string) => String(tAnalytics('aria.filters.intensitySlider', { type })),
    [tAnalytics],
  );
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="right"
        aria-label={String(tAnalytics('aria.filters.drawer'))}
      ...
      >
        <div className="flex-1 overflow-y-auto">
          <SheetHeader className="p-6 pb-2">
            ...
            <SheetDescription>
              {activeCounts.total > 0 ? labels.activeFilters : labels.noActive}
            </SheetDescription>
          </SheetHeader>
          ...
          <div className="px-6 py-4 bg-gradient-to-br from-muted/30 to-muted/10">
            <div className="mb-4">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                {String(
                  tAnalytics('filters.quickFiltersDesc', {
                    defaultValue: 'One-click filter combinations for common patterns',
                  }),
                )}
              </p>
            </div>
                          ...
                          ({
                            ...
                            emotions: preset.criteria.emotions
                              ? {
                                  ...
                                  intensityRange:
                                    clampRange(preset.criteria.emotions.intensityRange, 5) ??
                                    draft.emotions.intensityRange,
                                }
                              : draft.emotions,
                            sensory: preset.criteria.sensory
                              ? {
                                  ...
                                  intensityRange:
                                    clampRange(preset.criteria.sensory.intensityRange, 5) ??
                                    draft.sensory.intensityRange,
                                }
                              : draft.sensory,
          ...
          <section
            className="px-6 py-4"
            aria-label={String(
              tAnalytics('aria.filters.section', {
                section: tAnalytics('filters.categories.emotions'),
              }),
            )}
          >
            <Collapsible open={openEmotions} onOpenChange={setOpenEmotions}>
              <div className="flex items-center justify-between mb-3">
                ...
                >
                  <div
                    className={`w-2 h-2 rounded-full ${openEmotions ? 'bg-primary' : 'bg-muted-foreground'}`}
                  />
              ...
              <CollapsibleContent>
                <div className="mt-3 grid grid-cols-2 gap-2">
                  {EMOTION_TYPES.map((e) => (
                    <label key={e} className="flex items-center gap-2">
                      <Checkbox
                        aria-label={String(
                          tAnalytics('aria.filters.filterCheckbox', { filter: e }),
                        )}
                ...
                <div className="mt-4">
                  <div className="text-xs text-muted-foreground mb-2">
                    {String(tAnalytics('filters.emotions.intensity'))}
                  </div>
                  <Slider
                    ...
                    onValueChange={(val) =>
                      setDraft((prev) => ({
                        ...
                        emotions: {
                          ...prev.emotions,
                          intensityRange: [val[0], val[1]] as [number, number],
                        },
                      }))
                    }
                  />
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                  <div>
                    <div className="text-xs text-muted-foreground mb-2">
                      {String(tAnalytics('filters.emotions.includeTriggers'))}
                    </div>
                    <Select
                      onValueChange={(v) =>
                        setDraft((prev) => ({
                          ...
                          emotions: {
                            ...prev.emotions,
                            includeTriggers: Array.from(
                              new Set([...(prev.emotions.includeTriggers || []), v]),
                            ),
                          },
                        }))
                      }
                    >
                      <SelectTrigger className="w-full">
                        <SelectValue
                          placeholder={String(tAnalytics('filters.emotions.triggers'))}
                        />
                      </SelectTrigger>
                      <SelectContent>
                        {[
                            ...
                            <button
                              ...
                              onClick={() =>
                                setDraft((prev) => ({
                                  ...
                                  emotions: {
                                    ...prev.emotions,
                                    includeTriggers: prev.emotions.includeTriggers.filter(
                                      (x) => x !== t,
                                    ),
                                  },
                                }))
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground mb-2">
                      {String(tAnalytics('filters.emotions.excludeTriggers'))}
                    </div>
                    <Select
                      onValueChange={(v) =>
                        setDraft((prev) => ({
                          ...
                          emotions: {
                            ...prev.emotions,
                            excludeTriggers: Array.from(
                              new Set([...(prev.emotions.excludeTriggers || []), v]),
                            ),
                          },
                        }))
                      }
                            ...
                            <button
                              ...
                              onClick={() =>
                                setDraft((prev) => ({
                                  ...
                                  emotions: {
                                    ...prev.emotions,
                                    excludeTriggers: prev.emotions.excludeTriggers.filter(
                                      (x) => x !== t,
                                    ),
                                  },
                                }))
          ...
          <section
            ...
            aria-label={String(
              tAnalytics('aria.filters.section', {
                section: tAnalytics('filters.categories.sensory'),
              }),
            )}
          >
            ...
            {openSensory && (
              <>
                <div className="mt-3 grid grid-cols-2 gap-2">
                  {SENSORY_TYPES.map((s) => (
                    <label key={s} className="flex items-center gap-2">
                      <Checkbox
                        aria-label={String(
                          tAnalytics('aria.filters.filterCheckbox', { filter: s }),
                        )}
                        ...
                        onCheckedChange={(checked) =>
                          setDraft((prev) => ({
                            ...
                            sensory: {
                              ...
                              types: checked
                                ? Array.from(
                                    new Set([...(prev.sensory.types || []), s.toLowerCase()]),
                                  )
                ...
                <div className="mt-4 grid grid-cols-2 gap-2">
                  {SENSORY_RESPONSES.map((r) => (
                    <label key={r} className="flex items-center gap-2">
                      <Checkbox
                        aria-label={String(
                          tAnalytics('aria.filters.filterCheckbox', { filter: r }),
                        )}
                ...
                <div className="mt-4">
                  <div className="text-xs text-muted-foreground mb-2">
                    {String(tAnalytics('filters.sensory.intensity'))}
                  </div>
                  <Slider
          ...
          <section
            ...
            aria-label={String(
              tAnalytics('aria.filters.section', {
                section: tAnalytics('filters.categories.environmental'),
              }),
            )}
          >
            <div className="flex items-center justify-between">
            ...
            {openEnvironmental && (
              <>
                <div className="mt-3 grid grid-cols-2 gap-3">
                  <div>
                    <div className="text-xs text-muted-foreground mb-2">
                      {String(tAnalytics('filters.environmental.locations'))}
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      {LOCATIONS.map((loc) => (
                        <label key={loc} className="flex items-center gap-2">
                          <Checkbox
                            aria-label={String(
                              tAnalytics('aria.filters.filterCheckbox', { filter: loc }),
                            )}
                            ...
                            onCheckedChange={(checked) =>
                              setDraft((prev) => ({
                                ...
                                environmental: {
                                  ...
                                  locations: checked
                                    ? Array.from(
                                        new Set([...(prev.environmental.locations || []), loc]),
                                      )
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground mb-2">
                      {String(tAnalytics('filters.environmental.activities'))}
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      {ACTIVITIES.map((act) => (
                        <label key={act} className="flex items-center gap-2">
                          <Checkbox
                            aria-label={String(
                              tAnalytics('aria.filters.filterCheckbox', { filter: act }),
                            )}
                            ...
                            onCheckedChange={(checked) =>
                              setDraft((prev) => ({
                                ...
                                environmental: {
                                  ...
                                  activities: checked
                                    ? Array.from(
                                        new Set([...(prev.environmental.activities || []), act]),
                                      )
                ...
                <div className="mt-4 grid gap-4">
                  <div>
                    <div className="text-xs text-muted-foreground mb-2">
                      {String(tAnalytics('filters.environmental.noiseLevel'))}
                    </div>
                    <Slider
                      aria-label={intensityAria('noise')}
                      value={[
                        draft.environmental.conditions.noiseLevel[0],
                        draft.environmental.conditions.noiseLevel[1],
                      ]}
                      min={0}
                      max={10}
                      step={1}
                        ...
                        setDraft((prev) => ({
                          ...
                          environmental: {
                            ...
                            conditions: {
                              ...
                              noiseLevel: [val[0], val[1]] as [number, number],
                            },
                          },
                        }))
                      }
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground mb-2">
                      {String(tAnalytics('filters.environmental.temperature'))}
                    </div>
                    <Slider
                      aria-label={intensityAria('temperature')}
                      value={[
                        draft.environmental.conditions.temperature[0],
                        draft.environmental.conditions.temperature[1],
                      ]}
                      min={-10}
                      max={40}
                      step={1}
                      onValueChange={(val) =>
                        setDraft((prev) => ({
                          ...
                          environmental: {
                            ...
                            conditions: {
                              ...prev.environmental.conditions,
                              temperature: [val[0], val[1]] as [number, number],
                            },
                          },
                        }))
                      }
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                  <div>
                    <div className="text-xs text-muted-foreground mb-2">
                      {String(tAnalytics('filters.environmental.lighting'))}
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      {LIGHTING.map((l) => (
                        <label key={l} className="flex items-center gap-2">
                          <Checkbox
                            aria-label={String(
                              tAnalytics('aria.filters.filterCheckbox', { filter: l }),
                            )}
                                ...
                                environmental: {
                                  ...
                                  conditions: {
                                    ...
                                    lighting: checked
                                      ? Array.from(
                                          new Set([
                                            ...(prev.environmental.conditions.lighting || []),
                                            l,
                                          ]),
                                        )
                                      : prev.environmental.conditions.lighting.filter(
                                          (x) => x !== l,
                                        ),
                                  },
                                },
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground mb-2">
                      {String(tAnalytics('filters.environmental.weather'))}
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      {WEATHER.map((w) => (
                        <label key={w} className="flex items-center gap-2">
                          <Checkbox
                            aria-label={String(
                              tAnalytics('aria.filters.filterCheckbox', { filter: w }),
                            )}
                            ...
                            onCheckedChange={(checked) =>
                              setDraft((prev) => ({
                                ...
                                environmental: {
                                  ...
                                  weather: checked
                                    ? Array.from(
                                        new Set([...(prev.environmental.weather || []), w]),
                                      )
                ...
                <div className="mt-4">
                  <div className="text-xs text-muted-foreground mb-2">
                    {String(tAnalytics('filters.environmental.timeOfDay'))}
                  </div>
                  <div className="grid grid-cols-3 gap-2">
                    {TIME_OF_DAY.map((t) => (
                      <label key={t} className="flex items-center gap-2">
                        <Checkbox
                          aria-label={String(
                            tAnalytics('aria.filters.filterCheckbox', { filter: t }),
                          )}
                          ...
                          onCheckedChange={(checked) =>
                            setDraft((prev) => ({
                              ...
                              environmental: {
                                ...
                                timeOfDay: checked
                                  ? Array.from(
                                      new Set([...(prev.environmental.timeOfDay || []), t]),
                                    )
          ...
          <section
            ...
            aria-label={String(
              tAnalytics('aria.filters.section', {
                section: tAnalytics('filters.categories.patterns'),
              }),
            )}
          >
            <div className="flex items-center justify-between">
              ...
              <>
                <div className="mt-3 flex items-center justify-between">
                  <span className="text-sm">
                    {String(tAnalytics('filters.patterns.anomaliesOnly'))}
                  </span>
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setDraft((prev) => ({
                        ...prev,
                        patterns: { ...prev.patterns, anomaliesOnly: !!checked },
                      }))
                    }
                  />
                </div>
                <div className="mt-4">
                  <div className="text-xs text-muted-foreground mb-2">
                    {String(tAnalytics('filters.patterns.minConfidence'))}
                  </div>
                  <Slider
                    aria-label={String(
                      tAnalytics('filters.patterns.confidence', {
                    ...
                    onValueChange={(val) =>
                      setDraft((prev) => ({
                        ...prev,
                        patterns: { ...prev.patterns, minConfidence: val[0] },
                      }))
                    }
                  />
                </div>
                <div className="mt-4 grid grid-cols-2 gap-2">
                  {PATTERN_TYPES.map((p) => (
                    <label key={p} className="flex items-center gap-2">
                      <Checkbox
                        aria-label={String(
                          tAnalytics('aria.filters.filterCheckbox', { filter: p }),
                        )}
                        ...
                        onCheckedChange={(checked) =>
                          setDraft((prev) => ({
                            ...
                            patterns: {
                              ...prev.patterns,
                              patternTypes: checked
                                ? Array.from(
                                    new Set([
                                      ...(prev.patterns.patternTypes || []),
                                      p.toLowerCase(),
                                    ]),
                                  )
          ...
          <section
            ...
            aria-label={String(
              tAnalytics('aria.filters.section', {
                section: tAnalytics('filters.categories.advanced'),
              }),
            )}
          >
            <div className="flex items-center justify-between">
            ...
            {openAdvanced && (
              <div className="mt-3 flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setDraft((prev) => ({ ...prev, realtime: !!checked }))
                  }
                />
              </div>
            )}
        ...
        <div className="sticky bottom-0 w-full border-t bg-background p-4 flex items-center justify-between gap-2">
          <div className="text-xs text-muted-foreground">
            {activeCounts.total > 0
              ? String(tAnalytics('filters.activeFilters', { count: activeCounts.total }))
              : String(tAnalytics('filters.noActiveFilters'))}
          </div>
          <div className="flex gap-2">
            <Button
              variant="ghost"
              onClick={resetFilters}
              aria-label={String(tAnalytics('aria.filters.resetButton'))}
            >
            ...
            <Button
              ...
              aria-label={String(tAnalytics('aria.filters.applyButton'))}
              disabled={!modifiedSinceApply}
            >
