  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="backdrop-blur-md bg-popover/90 border border-border/40 shadow-lg">
        ...
        <DropdownMenuItem onClick={goMonitoring} className="cursor-pointer" data-testid="menu-monitoring">
          <Gauge className="h-4 w-4 mr-2" /> {String(tCommon('navigation.monitoring'))}
        </DropdownMenuItem>
