...
export const EnvironmentalCorrelationsDemo = () => {
  ...
  const [student, setStudent] = useState<Student>(() => generateCorrelatedData(baseStudent, 30));
    ...
    <div className="p-6 space-y-4">
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        ...
        <p className="text-sm text-gray-700 mb-4">
          This demo shows how environmental factors correlate with emotional responses. The data is
          generated to show a strong correlation between noise levels and anxiety.
        </p>
        <div className="flex gap-2">
          <Button
            onClick={() => regenerateData(7)}
            variant={dataSize === 7 ? 'default' : 'outline'}
          >
            1 Week
          </Button>
          <Button
            onClick={() => regenerateData(30)}
            variant={dataSize === 30 ? 'default' : 'outline'}
          >
            30 Days
          </Button>
          <Button
            onClick={() => regenerateData(90)}
            variant={dataSize === 90 ? 'default' : 'outline'}
          >
            90 Days
          </Button>
        </div>
