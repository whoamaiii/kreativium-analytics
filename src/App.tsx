...
const ReportBuilderPage = lazy(() =>
  import('./pages/ReportBuilderPage').then((m) => ({ default: m.default })),
);
...
const DevTools =
  !IS_PROD || POC_MODE
    ...
    : (null as unknown as React.LazyExoticComponent<() => JSX.Element>);
const CalibrationDashboard = lazy(() =>
  import('@/components/monitoring/CalibrationDashboard').then((m) => ({
    default: m.CalibrationDashboard,
  })),
);
