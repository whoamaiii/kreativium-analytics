...
const world = {
  ...
  rounds: [
    { target: 'happy', holdMs: 900, threshold: 0.6 },
  ],
};
...
describe('useGameLoop integration scoring', () => {
  it('applies combo and perfect window bonuses', () => {
    ...
    act(() => { result.current.score(1000, false, { combo: 3, perfect: true }); });
    ...
    act(() => { result.current.score(2000, false, { combo: 1, perfect: false }); });
